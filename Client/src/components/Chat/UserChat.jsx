...
const UserChat = ({ chat, user }) => {
  ...
  return (
    <div>
      {recipientUser?.name && (
        <div className="flex items-center justify-between mt-4 bg-slate-600 hover:bg-slate-500 cursor-pointer rounded-sm my-2 p-2 ">
          <div className="flex items-center">
            ...
            <div>
              <h3 className="text-xl">
                {" "}
                {recipientUser?.name} {activeStatus && <span className="ml-2 inline-block w-3 h-3  rounded-full bg-green-500"> </span> }{" "}
              </h3>
              <p> Text Message </p>
            </div>
          </div>
